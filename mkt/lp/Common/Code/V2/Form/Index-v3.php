<div id='popup-proccess-window' class='popup-window'>
    <div class='col-12'>
        <img src='/campaign/Common/images/squares.gif' />
    </div>
    <div class='col-12'>
		<span>
		Please wait...<br />
...
<?php if (canAccess()) { ?>
    <form name="register" id="register" method="post" enctype="application/x-www-form-urlencoded">
        ...
        <div class="col-12 mg-top-20 custom-submit-div">
            <span id='submitForm' class="btn btn-success"><?php echo GetFormTranslation('start_trading') ?></span>
        </div>
    </form>
<?php } else { ?>
    <br /><br />
    <h3 class='col-12 error'>Forbidden jurisdiction please contact support@finq.com</h3>
    <br /><br />
<?php } ?>
