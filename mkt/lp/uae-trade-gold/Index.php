...
$campaignId = "ff992cc2-b748-4a81-9fd8-da7b006359e7";

$assetInfo =getAsset('gold');
	...
	<div id="banner1" class="banner1 col-12">
        <div class="content">
            <div class="col-12 logo-row">
                ...
                <div class="pull-right available-platforms" style="display:none;">
    ...
    <div class="banner1-part2 col-12">
        <div class="content">
            ...
            <div class="col-4 buy-oil">
                ...
                <p class="price">$<?php //echo $assetInfo['buy']?><?php echo number_format($assetInfo['buy'], 2)?></p>
            </div>
            ...
            <div class="col-4 sell-oil">
                ...
                <p class="price">$<?php //echo $assetInfo['sell']?><?php echo number_format($assetInfo['sell'], 2)?></p>
            </div>
            <div class="col-12">
                <img class="graph" src="img/banners/graph-gold.png">
                <h3><?php echo GetPageTranslation('banner1_part2_h3')?></h3>
                <p><span onclick="goto()" class="btn btn-success buttonBanner"><?php echo GetPageTranslation('btn');?></span><a target="_blank" href="https://www.finq.com/<?php echo GetCleanLanguageCode(); ?>/instruments/gold"> <?php echo GetPageTranslation('btn_text');?></a></p>
            </div>
        </div>
    </div>
    ...
    <div id="platform-banner" class="full platform-banner">
        <div class="content">
            <div class="col-6">
                ...
                <a onclick="goto()" id="submitForm" class="btn btn-success buttonBanner "><?php echo GetPageTranslation('access_platform_btn')?></a>
           ...
           <!--     <h3><?php echo GetTermsTranslation('available_on')?></h3>
                ...
                <a href="https://app.appsflyer.com/com.finq.android?pid=Finq_Web"><img src="../Common/images/black/platforms/play-store.png"></a>
...
<script>
    $( document ).ready(function() {
        document.getElementsByName("ret")[0].value = "https://www.finq.com/mkt/lp/uae-trade-gold/success.php";
    });
    ...
    function showForm() {
//        if(isAndroid){
//            window.location.replace("https://app.appsflyer.com/com.finq.android?pid=Finq_Web");
//        }else if(isOS){
//            window.location.replace("https://app.appsflyer.com/id1280873475?pid=Finq_Web");
//        }else {
