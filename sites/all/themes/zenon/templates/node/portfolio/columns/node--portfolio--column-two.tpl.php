...
?>
<div id="node-<?php print $node->nid; ?>" class="col-sm-6 <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <a href="<?php print $link ?>" class="btn btn-sm btn-flat">Take a look</a>
