 ...
 * @see _biotic_theme()
 */
function biotic_theme(&$existing, $type, $theme, $path) {
  biotic_include($theme, 'theme/registry.inc');
  return _biotic_theme($existing, $type, $theme, $path);
}
 ...
 */
biotic_include('biotic', 'theme/alter.inc');
